# -*- encoding: utf-8 -*-
# stub: logstash-core 2.3.4 java lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<logstash-core-event>, ["= 2.3.4"])
      ...
      s.add_runtime_dependency(%q<jruby-openssl>, ["= 0.9.13"])
      ...
      s.add_dependency(%q<logstash-core-event>, ["= 2.3.4"])
      ...
      s.add_dependency(%q<jruby-openssl>, ["= 0.9.13"])
